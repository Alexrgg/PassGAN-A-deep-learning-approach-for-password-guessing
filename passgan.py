...
def main(hparams, model = None):
    ...
    trainer = Trainer(gpus = 0,limit_train_batches=1.0, max_epochs=5, benchmark=True,
                      checkpoint_callback = checkpoint_callback)
    #trainer = Trainer(accelerator=MPSAccelerator(), devices=1,limit_train_batches=1.0, max_epochs=5, benchmark=True) 
...
model = GAN(hparams)
#checkpoint = torch.load('./logs/Model.tar')
